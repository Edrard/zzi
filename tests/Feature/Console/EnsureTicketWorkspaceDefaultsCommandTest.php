...
class EnsureTicketWorkspaceDefaultsCommandTest extends TestCase
{
    ...
    public function test_it_migrates_old_ttl_seconds_to_minutes()
    {
    ...
    public function test_it_migrates_old_state_types_to_json_ids()
    {
        Setting::create([
            'key' => 'znuny_ticket_cache_active_state_types',
            'value' => 'new, pending reminder, pending auto',
            'type' => 'string',
        ]);
        ...
        $this->assertDatabaseHas('settings', [
            'key' => 'znuny_ticket_workspace_active_state_type_ids',
            'value' => '["new","pending_reminder","pending_auto"]',
        ]);
    }
