    ...
    'review' => [
        ...
        'actions' => [
            ...
            'manual_retry' => [
                ...
                'modal_description' => 'Це додасть в чергу новий запуск для цього запланованого завдання. Оригінальна спроба залишиться незмінною. Обробка відбудеться у звичайному режимі через планувальник. Якщо планувальник наразі призупинено або вимкнено, цей запуск чекатиме відновлення обробки.',
