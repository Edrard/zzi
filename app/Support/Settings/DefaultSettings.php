...
class DefaultSettings
{
    public static function all(): array
    {
        return [
            ...
            ['key' => 'owner_suggestion_similarity_threshold', 'value' => '80', 'type' => 'integer', 'description' => 'Minimum similarity percentage used when grouping similar problem names for owner suggestions.'],
            ['key' => 'owner_suggestion_statistics_retention_days', 'value' => '70', 'type' => 'integer', 'description' => 'Observations older than this remain stored but receive the old-statistics weight coefficient during aggregation.'],
            ['key' => 'owner_suggestion_old_weight_coefficient', 'value' => '0.5', 'type' => 'string', 'description' => 'Coefficient applied to observations older than the statistics retention window.'],
            ['key' => 'owner_suggestion_observation_cleanup_days', 'value' => '360', 'type' => 'integer', 'description' => 'Raw owner suggestion observations older than this are deleted during statistics rebuild.'],
            ['key' => 'owner_suggestion_rebuild_interval_minutes', 'value' => '180', 'type' => 'integer', 'description' => 'Minimum interval in minutes between automatic Owner Suggestion statistics rebuilds.'],
        ];
    }
}
