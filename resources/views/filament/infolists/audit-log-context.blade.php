...
<div class="fi-in-text">
    @if($isEmpty)
        <span class="text-sm text-gray-500 dark:text-gray-400">{{ __('audit_logs.labels.no_context') }}</span>
    @else
        ...
        @else
            ...
            <details style="margin-top: 16px;">
                <summary style="cursor: pointer; font-size: 0.75rem; color: rgb(156 163 175);">{{ __('audit_logs.labels.raw_context') }}</summary>
                <div style="margin-top: 8px;">
